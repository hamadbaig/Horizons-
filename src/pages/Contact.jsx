      ...
      <section className="contact">
        <div className="container flex">
          ...
          <div className="p-nousContacter">
            <p className="div-p-title">
              Si vous avez des questions, il vous suffit de remplir le
              formulaire de contact, et nous vous répondrons dans les plus brefs
              délais.
            </p>
          </div>
        </div>
