      ...
      {destination && (
        <>
          <article className="home ">
            ...
            <p>
              Découvrez la ville éternelle et plongez dans l&apos;histoire
              passionnante de {destination.location}{" "}
            </p>
          </article>
                ...
                <div className="box">
                  ...
                  <div className="content">
                    <div>
                      <h4>Le Colisée</h4>
                      <p>
                        Un amphithéâtre emblématique où se déroulaient des
                        combats de gladiateurs et d&apos;autres spectacles
                        publics dans l&apos;Antiquité.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="box">
                  ...
                  <div className="content">
                    <div>
                      <h4>Le Panthéon</h4>
                      <p>
                        Un temple antique dédié à tous les dieux, célèbre pour
                        son impressionnante coupole et ses murs de marbre.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="box">
                  ...
                  <div className="content">
                    <div>
                      ...
                      <p>
                        Une fontaine baroque ornée de sculptures de personnages
                        mythologiques, où les visiteurs peuvent jeter une pièce
                        de monnaie pour s&apos;assurer un retour à Rome.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="box">
                  ...
                  <div className="content">
                    <div>
                      ...
                      <p>
                        Une ancienne zone de rassemblement politique et sociale,
                        qui abrite aujourd&apos;hui des ruines antiques
                        impressionnantes, notamment l&apos;Arc de Titus et le
                        Temple de Saturne.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="content">
                    <div>
                      ...
                      <p>
                        ...
                        qui abrite une collection impressionnante de peintures,
                        de sculptures et d&apos;artefacts historiques.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="box">
                  ...
                  <div className="content">
                    <div>
                      ...
                      <p>
                        Une place baroque magnifique, ornée de fontaines et de
                        sculptures, et bordée de cafés et de restaurants.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="custom-destination-details-container">
              <div className="custom-destination-header">
                <img
                  ...
                  className="custom-destination-image"
                />
                <div className="custom-destination-info">
                  <h2 className="custom-destination-title">
                    {destination.title}
                  </h2>
                ...
                {destination.activities.map((activity, index) => (
                  <div key={index} className="custom-activity">
                    <img
                      ...
                      alt={activity.title}
                      className="custom-activity-image"
                    />
                    <div className="custom-activity-info">
                      <h3 className="custom-activity-title">
                        {activity.title}
                      </h3>
                      <p className="custom-activity-description">
